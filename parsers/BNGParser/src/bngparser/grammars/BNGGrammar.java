// $ANTLR 3.3 Nov 30, 2010 12:50:56 /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g 2012-03-26 20:21:13
...
public class BNGGrammar extends Parser {
    ...
    public final BNGGrammar.prog_return prog() throws RecognitionException {
        ...
        try {
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:76:1: ( ( ( BEGIN MODEL ( program_block )* END MODEL ) | ( program_block )* ) (a1= actions_block | ( BEGIN ACTIONS a2= actions_block END ACTIONS ) )? EOF -> prog2(parameters=$prog::parametersmolecules=moleculesspecies=$prog::seedSpeciesreactions=$prog::reactionRulesobservables=$prog::observablesfunctions=$prog::functionscompartments=$prog::compartments))
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:77:1: ( ( BEGIN MODEL ( program_block )* END MODEL ) | ( program_block )* ) (a1= actions_block | ( BEGIN ACTIONS a2= actions_block END ACTIONS ) )? EOF
            {
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:77:1: ( ( BEGIN MODEL ( program_block )* END MODEL ) | ( program_block )* )
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:77:2: ( BEGIN MODEL ( program_block )* END MODEL )
                    {
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:77:2: ( BEGIN MODEL ( program_block )* END MODEL )
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:77:3: BEGIN MODEL ( program_block )* END MODEL
                    {
                    match(input,BEGIN,FOLLOW_BEGIN_in_prog94); 
                    match(input,MODEL,FOLLOW_MODEL_in_prog96); 
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:77:15: ( program_block )*
                    loop1:
                    do {
                        int alt1=2;
                        ...
                        switch (alt1) {
                    	case 1 :
                    	    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:77:16: program_block
                    	    {
                    ...
                    break;
                case 2 :
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:77:45: ( program_block )*
                    {
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:77:45: ( program_block )*
                    loop2:
                    do {
                        ...
                        switch (alt2) {
                    	case 1 :
                    	    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:77:46: program_block
                    	    {
            ...
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:78:1: (a1= actions_block | ( BEGIN ACTIONS a2= actions_block END ACTIONS ) )?
            int alt4=3;
            ...
            switch (alt4) {
                case 1 :
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:78:2: a1= actions_block
                    {
                    ...
                    break;
                case 2 :
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:78:49: ( BEGIN ACTIONS a2= actions_block END ACTIONS )
                    {
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:78:49: ( BEGIN ACTIONS a2= actions_block END ACTIONS )
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:78:50: BEGIN ACTIONS a2= actions_block END ACTIONS
                    {
            ...
            // TEMPLATE REWRITE
            // 79:6: -> prog2(parameters=$prog::parametersmolecules=moleculesspecies=$prog::seedSpeciesreactions=$prog::reactionRulesobservables=$prog::observablesfunctions=$prog::functionscompartments=$prog::compartments)
            {
    ...
    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:84:1: version_def : VERSION LPAREN DBQUOTES VERSION_NUMBER DBQUOTES RPAREN SEMI ;
    public final BNGGrammar.version_def_return version_def() throws RecognitionException {
        ...
        try {
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:84:12: ( VERSION LPAREN DBQUOTES VERSION_NUMBER DBQUOTES RPAREN SEMI )
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:84:14: VERSION LPAREN DBQUOTES VERSION_NUMBER DBQUOTES RPAREN SEMI
            {
    ...
    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:88:1: program_block : ( parameters_block[memory,$prog::parameters] | molecule_types_block | seed_species_block[$prog::seedSpecies] | observables_block[$prog::observables] | reaction_rules_block[$prog::reactionRules] | functions_block | compartments_block );
    public final BNGGrammar.program_block_return program_block() throws RecognitionException {
        ...
        try {
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:89:1: ( parameters_block[memory,$prog::parameters] | molecule_types_block | seed_species_block[$prog::seedSpecies] | observables_block[$prog::observables] | reaction_rules_block[$prog::reactionRules] | functions_block | compartments_block )
            int alt5=7;
            ...
            switch (alt5) {
                case 1 :
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:89:3: parameters_block[memory,$prog::parameters]
                    {
                    ...
                    break;
                case 2 :
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:90:3: molecule_types_block
                    {
                    ...
                    break;
                case 3 :
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:91:3: seed_species_block[$prog::seedSpecies]
                    {
                    ...
                    break;
                case 4 :
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:92:3: observables_block[$prog::observables]
                    {
                    ...
                    break;
                case 5 :
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:93:3: reaction_rules_block[$prog::reactionRules]
                    {
                    ...
                    break;
                case 6 :
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:94:3: functions_block
                    {
                    ...
                    break;
                case 7 :
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:95:3: compartments_block
                    {
    ...
    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:101:1: functions_block : BEGIN FUNCTIONS ( function_def )* END FUNCTIONS ;
    public final BNGGrammar.functions_block_return functions_block() throws RecognitionException {
        ...
        try {
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:108:1: ( BEGIN FUNCTIONS ( function_def )* END FUNCTIONS )
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:109:7: BEGIN FUNCTIONS ( function_def )* END FUNCTIONS
            {
            match(input,BEGIN,FOLLOW_BEGIN_in_functions_block293); 
            match(input,FUNCTIONS,FOLLOW_FUNCTIONS_in_functions_block295); 
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:110:8: ( function_def )*
            loop6:
            do {
                int alt6=2;
                ...
                switch (alt6) {
            	case 1 :
            	    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:110:9: function_def
            	    {
    ...
    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:114:1: function_def : s1= STRING LPAREN ( STRING )? RPAREN ( BECOMES )? ( expression[memory] | if_expression ) -> functions_block(id=$s1.textreferencesName=$expression.reference.keySet()referencesType=Register.getTypes($expression.reference)expression=$expression.text);
    public final BNGGrammar.function_def_return function_def() throws RecognitionException {
        ...
        try {
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:114:13: (s1= STRING LPAREN ( STRING )? RPAREN ( BECOMES )? ( expression[memory] | if_expression ) -> functions_block(id=$s1.textreferencesName=$expression.reference.keySet()referencesType=Register.getTypes($expression.reference)expression=$expression.text))
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:115:5: s1= STRING LPAREN ( STRING )? RPAREN ( BECOMES )? ( expression[memory] | if_expression )
            {
            s1=(Token)match(input,STRING,FOLLOW_STRING_in_function_def339); 
            match(input,LPAREN,FOLLOW_LPAREN_in_function_def341); 
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:115:22: ( STRING )?
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:115:23: STRING
                    {
            ...
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:115:39: ( BECOMES )?
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:115:40: BECOMES
                    {
            ...
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:116:5: ( expression[memory] | if_expression )
            int alt9=2;
            int LA9_0 = input.LA(1);

            if ( (LA9_0==NOT||(LA9_0>=FLOAT && LA9_0<=INT)||LA9_0==STRING||LA9_0==LPAREN||LA9_0==MINUS) ) {
                alt9=1;
            }
            else if ( (LA9_0==IF) ) {
                alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:116:6: expression[memory]
                    {
                    pushFollow(FOLLOW_expression_in_function_def362);
                    ...
                    break;
                case 2 :
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:116:27: if_expression
                    {
                    pushFollow(FOLLOW_if_expression_in_function_def367);
                    if_expression();
            ...
            // TEMPLATE REWRITE
            // 121:5: -> functions_block(id=$s1.textreferencesName=$expression.reference.keySet()referencesType=Register.getTypes($expression.reference)expression=$expression.text)
            {
    ...
    protected static class if_expression_scope {
        Map<String,Register> references;
        Map<String,Register> lmemory;
    }
    protected Stack if_expression_stack = new Stack();
    ...
    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:126:1: if_expression : IF LPAREN STRING EQUALS INT COMMA expression[memory] COMMA expression[memory] RPAREN ;
    public final BNGGrammar.if_expression_return if_expression() throws RecognitionException {
        if_expression_stack.push(new if_expression_scope());
        BNGGrammar.if_expression_return retval = new BNGGrammar.if_expression_return();
        retval.start = input.LT(1);


          ((if_expression_scope)if_expression_stack.peek()).references = new HashMap<String,Register>();
          ((if_expression_scope)if_expression_stack.peek()).lmemory = memory;

        try {
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:134:2: ( IF LPAREN STRING EQUALS INT COMMA expression[memory] COMMA expression[memory] RPAREN )
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:136:3: IF LPAREN STRING EQUALS INT COMMA expression[memory] COMMA expression[memory] RPAREN
            {
            match(input,IF,FOLLOW_IF_in_if_expression483); 
            match(input,LPAREN,FOLLOW_LPAREN_in_if_expression485); 
            match(input,STRING,FOLLOW_STRING_in_if_expression487); 

                
              
            match(input,EQUALS,FOLLOW_EQUALS_in_if_expression496); 
            match(input,INT,FOLLOW_INT_in_if_expression498); 
            match(input,COMMA,FOLLOW_COMMA_in_if_expression500); 
            pushFollow(FOLLOW_expression_in_if_expression502);
            expression(memory);

            state._fsp--;

            match(input,COMMA,FOLLOW_COMMA_in_if_expression505); 
            pushFollow(FOLLOW_expression_in_if_expression507);
            expression(memory);

            state._fsp--;

            match(input,RPAREN,FOLLOW_RPAREN_in_if_expression510); 
    ...
    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:144:1: compartments_block : BEGIN COMPARTMENTS ( compartment )* END COMPARTMENTS ;
    public final BNGGrammar.compartments_block_return compartments_block() throws RecognitionException {
        ...
        try {
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:144:19: ( BEGIN COMPARTMENTS ( compartment )* END COMPARTMENTS )
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:146:3: BEGIN COMPARTMENTS ( compartment )* END COMPARTMENTS
            {
            match(input,BEGIN,FOLLOW_BEGIN_in_compartments_block522); 
            match(input,COMPARTMENTS,FOLLOW_COMPARTMENTS_in_compartments_block524); 
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:147:7: ( compartment )*
            loop10:
            do {
                int alt10=2;
                ...
                switch (alt10) {
            	case 1 :
            	    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:147:8: compartment
            	    {
            	    pushFollow(FOLLOW_compartment_in_compartments_block533);
            ...
            match(input,END,FOLLOW_END_in_compartments_block541); 
            match(input,COMPARTMENTS,FOLLOW_COMPARTMENTS_in_compartments_block543); 
    ...
    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:150:1: compartment : s1= STRING INT s3= expression[memory] (s2= STRING )? -> compartments_block(id=$s1.textdimensions=$INT.textsize=$s3.valueoutside=$s2.text);
    public final BNGGrammar.compartment_return compartment() throws RecognitionException {
        ...
        try {
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:150:12: (s1= STRING INT s3= expression[memory] (s2= STRING )? -> compartments_block(id=$s1.textdimensions=$INT.textsize=$s3.valueoutside=$s2.text))
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:151:4: s1= STRING INT s3= expression[memory] (s2= STRING )?
            {
            s1=(Token)match(input,STRING,FOLLOW_STRING_in_compartment557); 
            INT4=(Token)match(input,INT,FOLLOW_INT_in_compartment559); 
            pushFollow(FOLLOW_expression_in_compartment563);
            s3=expression(memory);

            state._fsp--;

            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:151:40: (s2= STRING )?
            int alt11=2;
            ...
            if ( (LA11_0==STRING) ) {
                ...
                if ( (LA11_1==END||LA11_1==STRING) ) {
                    alt11=1;
                }
            }
            switch (alt11) {
                case 1 :
                    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:151:41: s2= STRING
                    {
                    s2=(Token)match(input,STRING,FOLLOW_STRING_in_compartment569); 
            ...
            // TEMPLATE REWRITE
            // 151:53: -> compartments_block(id=$s1.textdimensions=$INT.textsize=$s3.valueoutside=$s2.text)
            {
    ...
    // $ANTLR start "label"
    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:154:1: label returns [String label] : MOD STRING ;
    public final BNGGrammar.label_return label() throws RecognitionException {
        ...
        try {
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:154:29: ( MOD STRING )
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:155:3: MOD STRING
            {
            match(input,MOD,FOLLOW_MOD_in_label609); 
            STRING5=(Token)match(input,STRING,FOLLOW_STRING_in_label611); 
    ...
    // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:157:1: dereference returns [String label] : AMPERSAND STRING ;
    public final BNGGrammar.dereference_return dereference() throws RecognitionException {
        ...
        try {
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:157:35: ( AMPERSAND STRING )
            // /home/proto/workspace/bionetgen/parsers/BNGParser/src/bngparser/grammars/BNGGrammar.g:158:3: AMPERSAND STRING
            {
            match(input,AMPERSAND,FOLLOW_AMPERSAND_in_dereference627); 
            STRING6=(Token)match(input,STRING,FOLLOW_STRING_in_dereference629); 
    ...
    // Delegated rules
    public BNGGrammar_BNGGrammar_ReactionRules.rate_function_return rate_function(List<String> rateList) throws RecognitionException { return gBNGGrammar_ReactionRules.rate_function(rateList); }
    ...
    public BNGGrammar_BNGGrammar_ReactionRules.rate_list_return rate_list(List<String> rateList) throws RecognitionException { return gBNGGrammar_ReactionRules.rate_list(rateList); }
    ...
    public static final BitSet FOLLOW_MODEL_in_prog105 = new BitSet(new long[]{0xB800000000000100L,0x00000000000000FFL});
    public static final BitSet FOLLOW_program_block_in_prog111 = new BitSet(new long[]{0xB800000000000100L,0x00000000000000FFL});
    ...
    public static final BitSet FOLLOW_ACTIONS_in_prog127 = new BitSet(new long[]{0xB800000000000000L,0x00000000000000FFL});
    ...
    public static final BitSet FOLLOW_VERSION_in_version_def217 = new BitSet(new long[]{0x0000000000000000L,0x0000000001000000L});
    public static final BitSet FOLLOW_LPAREN_in_version_def219 = new BitSet(new long[]{0x0000000000000000L,0x0000400000000000L});
    public static final BitSet FOLLOW_DBQUOTES_in_version_def221 = new BitSet(new long[]{0x0000000000000000L,0x0008000000000000L});
    public static final BitSet FOLLOW_VERSION_NUMBER_in_version_def223 = new BitSet(new long[]{0x0000000000000000L,0x0000400000000000L});
    public static final BitSet FOLLOW_DBQUOTES_in_version_def225 = new BitSet(new long[]{0x0000000000000000L,0x0000000002000000L});
    public static final BitSet FOLLOW_RPAREN_in_version_def227 = new BitSet(new long[]{0x0000000000000000L,0x0000000000010000L});
    ...
    public static final BitSet FOLLOW_FUNCTIONS_in_functions_block295 = new BitSet(new long[]{0x0000000000000080L,0x0000000000008000L});
    public static final BitSet FOLLOW_function_def_in_functions_block306 = new BitSet(new long[]{0x0000000000000080L,0x0000000000008000L});
    ...
    public static final BitSet FOLLOW_STRING_in_function_def339 = new BitSet(new long[]{0x0000000000000000L,0x0000000001000000L});
    public static final BitSet FOLLOW_LPAREN_in_function_def341 = new BitSet(new long[]{0x0000000000000000L,0x0000000002008000L});
    public static final BitSet FOLLOW_STRING_in_function_def344 = new BitSet(new long[]{0x0000000000000000L,0x0000000002000000L});
    public static final BitSet FOLLOW_RPAREN_in_function_def348 = new BitSet(new long[]{0x0000400400000000L,0x000001200100B000L});
    public static final BitSet FOLLOW_BECOMES_in_function_def351 = new BitSet(new long[]{0x0000400400000000L,0x000001200100B000L});
    public static final BitSet FOLLOW_expression_in_function_def362 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_if_expression_in_function_def367 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_IF_in_if_expression483 = new BitSet(new long[]{0x0000000000000000L,0x0000000001000000L});
    public static final BitSet FOLLOW_LPAREN_in_if_expression485 = new BitSet(new long[]{0x0000000000000000L,0x0000000000008000L});
    public static final BitSet FOLLOW_STRING_in_if_expression487 = new BitSet(new long[]{0x0000000000000000L,0x0000001000000000L});
    public static final BitSet FOLLOW_EQUALS_in_if_expression496 = new BitSet(new long[]{0x0000000000000000L,0x0000000000002000L});
    public static final BitSet FOLLOW_INT_in_if_expression498 = new BitSet(new long[]{0x0000000000000000L,0x0000000000400000L});
    public static final BitSet FOLLOW_COMMA_in_if_expression500 = new BitSet(new long[]{0x0000400000000000L,0x000001000100B000L});
    public static final BitSet FOLLOW_expression_in_if_expression502 = new BitSet(new long[]{0x0000000000000000L,0x0000000000400000L});
    public static final BitSet FOLLOW_COMMA_in_if_expression505 = new BitSet(new long[]{0x0000400000000000L,0x000001000100B000L});
    public static final BitSet FOLLOW_expression_in_if_expression507 = new BitSet(new long[]{0x0000000000000000L,0x0000000002000000L});
    public static final BitSet FOLLOW_RPAREN_in_if_expression510 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_BEGIN_in_compartments_block522 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_COMPARTMENTS_in_compartments_block524 = new BitSet(new long[]{0x0000000000000080L,0x0000000000008000L});
    public static final BitSet FOLLOW_compartment_in_compartments_block533 = new BitSet(new long[]{0x0000000000000080L,0x0000000000008000L});
    public static final BitSet FOLLOW_END_in_compartments_block541 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_COMPARTMENTS_in_compartments_block543 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_STRING_in_compartment557 = new BitSet(new long[]{0x0000000000000000L,0x0000000000002000L});
    public static final BitSet FOLLOW_INT_in_compartment559 = new BitSet(new long[]{0x0000400000000000L,0x000001000100B000L});
    public static final BitSet FOLLOW_expression_in_compartment563 = new BitSet(new long[]{0x0000000000000002L,0x0000000000008000L});
    public static final BitSet FOLLOW_STRING_in_compartment569 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_MOD_in_label609 = new BitSet(new long[]{0x0000000000000000L,0x0000000000008000L});
    public static final BitSet FOLLOW_STRING_in_label611 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_AMPERSAND_in_dereference627 = new BitSet(new long[]{0x0000000000000000L,0x0000000000008000L});
    public static final BitSet FOLLOW_STRING_in_dereference629 = new BitSet(new long[]{0x0000000000000002L});
