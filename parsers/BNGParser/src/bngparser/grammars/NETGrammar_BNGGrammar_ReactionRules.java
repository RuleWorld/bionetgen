// $ANTLR 3.3 Nov 30, 2010 12:50:56 BNGGrammar_ReactionRules.g 2013-01-14 18:13:03
...
import java.util.HashMap;
public class NETGrammar_BNGGrammar_ReactionRules extends Parser {
    ...
    public NETGrammar gParent;
        ...
        public NETGrammar_BNGGrammar_ReactionRules(TokenStream input, NETGrammar gNETGrammar) {
            this(input, new RecognizerSharedState(), gNETGrammar);
        }
        public NETGrammar_BNGGrammar_ReactionRules(TokenStream input, RecognizerSharedState state, NETGrammar gNETGrammar) {
            super(input, state);
    ...
    protected StringTemplateGroup templateLib =
      new StringTemplateGroup("NETGrammar_BNGGrammar_ReactionRulesTemplates", AngleBracketTemplateLexer.class);
    ...
    public final NETGrammar_BNGGrammar_ReactionRules.population_maps_block_return population_maps_block() throws RecognitionException {
        NETGrammar_BNGGrammar_ReactionRules.population_maps_block_return retval = new NETGrammar_BNGGrammar_ReactionRules.population_maps_block_return();
    ...
    public final NETGrammar_BNGGrammar_ReactionRules.reaction_rules_block_return reaction_rules_block(List reactionRules) throws RecognitionException {
        reaction_rules_block_stack.push(new reaction_rules_block_scope());
        NETGrammar_BNGGrammar_ReactionRules.reaction_rules_block_return retval = new NETGrammar_BNGGrammar_ReactionRules.reaction_rules_block_return();
        retval.start = input.LT(1);

        NETGrammar_BNGGrammar_ReactionRules.reaction_rule_def_return reaction_rule_def1 = null;
    ...
    public final NETGrammar_BNGGrammar_ReactionRules.reactionLabel_return reactionLabel() throws RecognitionException {
        NETGrammar_BNGGrammar_ReactionRules.reactionLabel_return retval = new NETGrammar_BNGGrammar_ReactionRules.reactionLabel_return();
        retval.start = input.LT(1);
    ...
    public final NETGrammar_BNGGrammar_ReactionRules.reactionReference_return reactionReference() throws RecognitionException {
        NETGrammar_BNGGrammar_ReactionRules.reactionReference_return retval = new NETGrammar_BNGGrammar_ReactionRules.reactionReference_return();
        retval.start = input.LT(1);
    ...
    public final NETGrammar_BNGGrammar_ReactionRules.reaction_rule_def_return reaction_rule_def(int reactionCounter) throws RecognitionException {
        reaction_rule_def_stack.push(new reaction_rule_def_scope());
        NETGrammar_BNGGrammar_ReactionRules.reaction_rule_def_return retval = new NETGrammar_BNGGrammar_ReactionRules.reaction_rule_def_return();
        retval.start = input.LT(1);

        NETGrammar_BNGGrammar_ReactionRules.reactionLabel_return l1 = null;

        NETGrammar_BNGGrammar_ReactionRules.rate_function_return bi = null;

        NETGrammar_BNGGrammar_ReactionRules.reaction_def_return reaction_def4 = null;
    ...
    public final NETGrammar_BNGGrammar_ReactionRules.match_attribute_return match_attribute() throws RecognitionException {
        NETGrammar_BNGGrammar_ReactionRules.match_attribute_return retval = new NETGrammar_BNGGrammar_ReactionRules.match_attribute_return();
        retval.start = input.LT(1);
    ...
    public final NETGrammar_BNGGrammar_ReactionRules.reaction_def_return reaction_def(List patternsReactants, List patternsProducts, String upperID) throws RecognitionException {
        reaction_def_stack.push(new reaction_def_scope());
        NETGrammar_BNGGrammar_ReactionRules.reaction_def_return retval = new NETGrammar_BNGGrammar_ReactionRules.reaction_def_return();
        retval.start = input.LT(1);

        NETGrammar_BNGGrammar_ReactionRules.rule_species_def_return s1 = null;

        NETGrammar_BNGGrammar_ReactionRules.rule_species_def_return s2 = null;

        NETGrammar_BNGGrammar_ReactionRules.rule_species_def_return s3 = null;

        NETGrammar_BNGGrammar_ReactionRules.rule_species_def_return s4 = null;
    ...
    public final NETGrammar_BNGGrammar_ReactionRules.rule_species_def_return rule_species_def(String upperID, ReactionAction reactionAction) throws RecognitionException {
        rule_species_def_stack.push(new rule_species_def_scope());
        NETGrammar_BNGGrammar_ReactionRules.rule_species_def_return retval = new NETGrammar_BNGGrammar_ReactionRules.rule_species_def_return();
        retval.start = input.LT(1);

        Token i1=null;
        Token i2=null;
        NETGrammar_BNGGrammar_SeedSpecies.species_def_return s1 = null;
        ...
        try {
            ...
            switch (alt19) {
                case 1 :
                    ...
                    s1=gNETGrammar.species_def(((rule_species_def_scope)rule_species_def_stack.peek()).reactants, ((rule_species_def_scope)rule_species_def_stack.peek()).bonds, upperID);
    ...
    public final NETGrammar_BNGGrammar_ReactionRules.rate_function_return rate_function(List<String> rateList, boolean bidirectional) throws RecognitionException {
        NETGrammar_BNGGrammar_ReactionRules.rate_function_return retval = new NETGrammar_BNGGrammar_ReactionRules.rate_function_return();
        retval.start = input.LT(1);

        NETGrammar_BNGGrammar_ReactionRules.function_keyword_return function_keyword5 = null;
    ...
    public final NETGrammar_BNGGrammar_ReactionRules.function_keyword_return function_keyword() throws RecognitionException {
        NETGrammar_BNGGrammar_ReactionRules.function_keyword_return retval = new NETGrammar_BNGGrammar_ReactionRules.function_keyword_return();
        retval.start = input.LT(1);
    ...
    public final NETGrammar_BNGGrammar_ReactionRules.rate_list_return rate_list(List<String> rateList, boolean bidirectional) throws RecognitionException {
        rate_list_stack.push(new rate_list_scope());
        NETGrammar_BNGGrammar_ReactionRules.rate_list_return retval = new NETGrammar_BNGGrammar_ReactionRules.rate_list_return();
        retval.start = input.LT(1);

        NETGrammar_BNGGrammar_Expression.expression_return e1 = null;

        NETGrammar_BNGGrammar_Expression.expression_return e2 = null;
        ...
        try {
            ...
            e1=gNETGrammar.expression(((rate_list_scope)rate_list_stack.peek()).memoryWithLocal);
            ...
            switch (alt22) {
                case 1 :
                    ...
                    e2=gNETGrammar.expression(((rate_list_scope)rate_list_stack.peek()).memoryWithLocal);
    ...
    public final NETGrammar_BNGGrammar_ReactionRules.modif_command_return modif_command() throws RecognitionException {
        NETGrammar_BNGGrammar_ReactionRules.modif_command_return retval = new NETGrammar_BNGGrammar_ReactionRules.modif_command_return();
        retval.start = input.LT(1);
    ...
    public final NETGrammar_BNGGrammar_ReactionRules.include_command_return include_command() throws RecognitionException {
        NETGrammar_BNGGrammar_ReactionRules.include_command_return retval = new NETGrammar_BNGGrammar_ReactionRules.include_command_return();
        retval.start = input.LT(1);
    ...
    public final NETGrammar_BNGGrammar_ReactionRules.exclude_command_return exclude_command() throws RecognitionException {
        NETGrammar_BNGGrammar_ReactionRules.exclude_command_return retval = new NETGrammar_BNGGrammar_ReactionRules.exclude_command_return();
        retval.start = input.LT(1);
    ...
    public final NETGrammar_BNGGrammar_ReactionRules.pattern_return pattern() throws RecognitionException {
        NETGrammar_BNGGrammar_ReactionRules.pattern_return retval = new NETGrammar_BNGGrammar_ReactionRules.pattern_return();
        retval.start = input.LT(1);
