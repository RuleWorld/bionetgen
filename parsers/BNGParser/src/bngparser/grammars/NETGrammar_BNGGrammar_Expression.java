// $ANTLR 3.3 Nov 30, 2010 12:50:56 BNGGrammar_Expression.g 2013-01-14 18:13:03
...
import java.util.HashMap;
public class NETGrammar_BNGGrammar_Expression extends Parser {
    ...
    public NETGrammar gParent;
        ...
        public NETGrammar_BNGGrammar_Expression(TokenStream input, NETGrammar gNETGrammar) {
            this(input, new RecognizerSharedState(), gNETGrammar);
        }
        public NETGrammar_BNGGrammar_Expression(TokenStream input, RecognizerSharedState state, NETGrammar gNETGrammar) {
            super(input, state);
    ...
    protected StringTemplateGroup templateLib =
      new StringTemplateGroup("NETGrammar_BNGGrammar_ExpressionTemplates", AngleBracketTemplateLexer.class);
    ...
    public final NETGrammar_BNGGrammar_Expression.expression_return expression(Map<String,Register> memory) throws RecognitionException {
        expression_stack.push(new expression_scope());
        NETGrammar_BNGGrammar_Expression.expression_return retval = new NETGrammar_BNGGrammar_Expression.expression_return();
        retval.start = input.LT(1);

        NETGrammar_BNGGrammar_Expression.expression2_return expression21 = null;
    ...
    public final NETGrammar_BNGGrammar_Expression.expression2_return expression2() throws RecognitionException {
        NETGrammar_BNGGrammar_Expression.expression2_return retval = new NETGrammar_BNGGrammar_Expression.expression2_return();
        retval.start = input.LT(1);

        NETGrammar_BNGGrammar_Expression.relational_expression_return e1 = null;
    ...
    public final NETGrammar_BNGGrammar_Expression.relational_expression_return relational_expression() throws RecognitionException {
        NETGrammar_BNGGrammar_Expression.relational_expression_return retval = new NETGrammar_BNGGrammar_Expression.relational_expression_return();
        retval.start = input.LT(1);

        NETGrammar_BNGGrammar_Expression.adding_expression_return a1 = null;
    ...
    public final NETGrammar_BNGGrammar_Expression.adding_expression_return adding_expression() throws RecognitionException {
        NETGrammar_BNGGrammar_Expression.adding_expression_return retval = new NETGrammar_BNGGrammar_Expression.adding_expression_return();
        retval.start = input.LT(1);

        NETGrammar_BNGGrammar_Expression.multiplying_expression_return s1 = null;

        NETGrammar_BNGGrammar_Expression.multiplying_expression_return s2 = null;

        NETGrammar_BNGGrammar_Expression.multiplying_expression_return s3 = null;
    ...
    public final NETGrammar_BNGGrammar_Expression.multiplying_expression_return multiplying_expression() throws RecognitionException {
        NETGrammar_BNGGrammar_Expression.multiplying_expression_return retval = new NETGrammar_BNGGrammar_Expression.multiplying_expression_return();
        retval.start = input.LT(1);

        NETGrammar_BNGGrammar_Expression.power_expression_return s1 = null;

        NETGrammar_BNGGrammar_Expression.power_expression_return s2 = null;

        NETGrammar_BNGGrammar_Expression.power_expression_return s3 = null;
    ...
    public final NETGrammar_BNGGrammar_Expression.power_expression_return power_expression() throws RecognitionException {
        NETGrammar_BNGGrammar_Expression.power_expression_return retval = new NETGrammar_BNGGrammar_Expression.power_expression_return();
        retval.start = input.LT(1);

        NETGrammar_BNGGrammar_Expression.sign_expression_return s1 = null;

        NETGrammar_BNGGrammar_Expression.sign_expression_return s2 = null;
    ...
    public final NETGrammar_BNGGrammar_Expression.sign_expression_return sign_expression() throws RecognitionException {
        NETGrammar_BNGGrammar_Expression.sign_expression_return retval = new NETGrammar_BNGGrammar_Expression.sign_expression_return();
        retval.start = input.LT(1);

        NETGrammar_BNGGrammar_Expression.boolean_negation_expression_return boolean_negation_expression2 = null;
    ...
    public final NETGrammar_BNGGrammar_Expression.boolean_negation_expression_return boolean_negation_expression() throws RecognitionException {
        NETGrammar_BNGGrammar_Expression.boolean_negation_expression_return retval = new NETGrammar_BNGGrammar_Expression.boolean_negation_expression_return();
        retval.start = input.LT(1);

        Token n=null;
        NETGrammar_BNGGrammar_Expression.primitive_element_return e = null;
    ...
    public final NETGrammar_BNGGrammar_Expression.primitive_element_return primitive_element() throws RecognitionException {
        NETGrammar_BNGGrammar_Expression.primitive_element_return retval = new NETGrammar_BNGGrammar_Expression.primitive_element_return();
        retval.start = input.LT(1);

        NETGrammar_BNGGrammar_Expression.expression2_return e1 = null;

        NETGrammar_BNGGrammar_Expression.expression2_return e2 = null;

        NETGrammar_BNGGrammar_Expression.number_return number3 = null;

        NETGrammar_BNGGrammar_Expression.if_expression_return if_expression4 = null;

        NETGrammar_BNGGrammar_Expression.function_return function5 = null;

        NETGrammar_BNGGrammar_Expression.variable_return variable6 = null;
    ...
    public final NETGrammar_BNGGrammar_Expression.number_return number() throws RecognitionException {
        NETGrammar_BNGGrammar_Expression.number_return retval = new NETGrammar_BNGGrammar_Expression.number_return();
        retval.start = input.LT(1);
    ...
    public final NETGrammar_BNGGrammar_Expression.variable_return variable() throws RecognitionException {
        NETGrammar_BNGGrammar_Expression.variable_return retval = new NETGrammar_BNGGrammar_Expression.variable_return();
        retval.start = input.LT(1);
    ...
    public final NETGrammar_BNGGrammar_Expression.if_expression_return if_expression() throws RecognitionException {
        NETGrammar_BNGGrammar_Expression.if_expression_return retval = new NETGrammar_BNGGrammar_Expression.if_expression_return();
        retval.start = input.LT(1);
    ...
    public final NETGrammar_BNGGrammar_Expression.function_return function() throws RecognitionException {
        NETGrammar_BNGGrammar_Expression.function_return retval = new NETGrammar_BNGGrammar_Expression.function_return();
        retval.start = input.LT(1);
    ...
    public final void synpred1_BNGGrammar_Expression_fragment() throws RecognitionException {   
        ...
        do {
            ...
            if ( ((LA13_0>=LINE_COMMENT && LA13_0<=LPAREN)||(LA13_0>=UNI_REACTION_SIGN && LA13_0<=210)) ) {
                alt13=1;
            }
        	...
        	case 1 :
        	    ...
        	    {
        	    if ( (input.LA(1)>=LINE_COMMENT && input.LA(1)<=LPAREN)||(input.LA(1)>=UNI_REACTION_SIGN && input.LA(1)<=210) ) {
        	        input.consume();
        	        state.errorRecovery=false;state.failed=false;
        	    }
        	    else {
    ...
    public static final BitSet FOLLOW_LPAREN_in_synpred1_BNGGrammar_Expression361 = new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L,0xDFFFFFFFFFFFFFFFL,0xFFFFFFFFFFFFFFFFL,0x000000000007FFFFL});
    public static final BitSet FOLLOW_set_in_synpred1_BNGGrammar_Expression364 = new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L,0xFFFFFFFFFFFFFFFFL,0xFFFFFFFFFFFFFFFFL,0x000000000007FFFFL});
