...
class AnnotationExtractor:
    def __init__(self, fileName):
        ...
        self.sct, self.database, self.sbmlDocument = self.obtainSCT(self.fileName, 'config/reactionDefinitions.json', False, 'config/namingConventions.json')
    ...
    def obtainSCT(self, fileName, reactionDefinitions, useID, namingConventions):
        '''
