// $ANTLR 3.3 Nov 30, 2010 12:50:56 BNGGrammar_Actions.g 2012-01-25 16:16:35
...
public class BNGGrammar_BNGGrammar_Actions extends Parser {
    ...
    public final BNGGrammar_BNGGrammar_Actions.simulate_ode_return simulate_ode(Map<String,String> map) throws RecognitionException {
        ...
        try {
            ...
            if ( ((LA13_0>=PREFFIX && LA13_0<=SUFFIX)||(LA13_0>=ATOL && LA13_0<=SAMPLE_TIMES)) ) {
                alt13=1;
            }
            switch (alt13) {
                case 1 :
    ...
    public final BNGGrammar_BNGGrammar_Actions.simulate_ssa_return simulate_ssa(Map<String,String> map) throws RecognitionException {
        ...
        try {
            ...
            if ( ((LA17_0>=PREFFIX && LA17_0<=SUFFIX)||(LA17_0>=T_END && LA17_0<=SAMPLE_TIMES)) ) {
                alt17=1;
            }
            switch (alt17) {
                case 1 :
                    ...
                    else if ( ((LA14_0>=T_END && LA14_0<=SAMPLE_TIMES)) ) {
                        alt14=2;
                    }
                    else {
                        NoViableAltException nvae =
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    else if ( ((LA15_0>=T_END && LA15_0<=SAMPLE_TIMES)) ) {
                    	        alt15=2;
                    	    }
                    	    else {
                    	        NoViableAltException nvae =
    ...
    // BNGGrammar_Actions.g:193:1: simulate_par_def[Map<String,String> map] : ( T_END ASSIGNS (i1= INT | f1= FLOAT ) | T_START ASSIGNS (i2= INT | f2= FLOAT ) | N_STEPS ASSIGNS i3= INT | SAMPLE_TIMES ASSIGNS i4= array_value );
    public final BNGGrammar_BNGGrammar_Actions.simulate_par_def_return simulate_par_def(Map<String,String> map) throws RecognitionException {
        ...
        try {
            // BNGGrammar_Actions.g:194:9: ( T_END ASSIGNS (i1= INT | f1= FLOAT ) | T_START ASSIGNS (i2= INT | f2= FLOAT ) | N_STEPS ASSIGNS i3= INT | SAMPLE_TIMES ASSIGNS i4= array_value )
            int alt29=4;
            switch ( input.LA(1) ) {
            case T_END:
                {
    ...
    // BNGGrammar_Actions.g:200:1: array_value : LSBRACKET STRING ( COMMA STRING )* RSBRACKET ;
    public final BNGGrammar_BNGGrammar_Actions.array_value_return array_value() throws RecognitionException {
        ...
        try {
            // BNGGrammar_Actions.g:201:9: ( LSBRACKET STRING ( COMMA STRING )* RSBRACKET )
            // BNGGrammar_Actions.g:201:11: LSBRACKET STRING ( COMMA STRING )* RSBRACKET
            {
            match(input,LSBRACKET,FOLLOW_LSBRACKET_in_array_value1696); 
            match(input,STRING,FOLLOW_STRING_in_array_value1698); 
            // BNGGrammar_Actions.g:201:28: ( COMMA STRING )*
            loop30:
            do {
                int alt30=2;
                ...
                switch (alt30) {
            	case 1 :
            	    // BNGGrammar_Actions.g:201:29: COMMA STRING
            	    {
            	    match(input,COMMA,FOLLOW_COMMA_in_array_value1701); 
            	    match(input,STRING,FOLLOW_STRING_in_array_value1703); 
            ...
            match(input,RSBRACKET,FOLLOW_RSBRACKET_in_array_value1707); 
    ...
    static final String[] DFA1_transitionS = {
            "\4\14\1\12\60\14\1\2\1\3\1\4\1\14\4\5\1\6\1\7\1\10\1\11\1\1"+
            "\176\14",
            "",
            "",
            "",
    ...
    public static final BitSet FOLLOW_ACTIONS_in_actions_prog52 = new BitSet(new long[]{0xEE00000000000000L,0x000000000000003FL});
    ...
    public static final BitSet FOLLOW_action_in_actions_block101 = new BitSet(new long[]{0xEE00000000000002L,0x000000000000003FL});
    ...
    public static final BitSet FOLLOW_GENERATENETWORK_in_generate_network244 = new BitSet(new long[]{0x0000000000000000L,0x0000000000200000L});
    public static final BitSet FOLLOW_LPAREN_in_generate_network246 = new BitSet(new long[]{0x0000000000000000L,0x0000000000420000L});
    public static final BitSet FOLLOW_LBRACKET_in_generate_network249 = new BitSet(new long[]{0x0000000C7C000000L,0x0000000000040000L});
    public static final BitSet FOLLOW_gn_action_par_def_in_generate_network261 = new BitSet(new long[]{0x0000000000000000L,0x00000000000C0000L});
    public static final BitSet FOLLOW_COMMA_in_generate_network275 = new BitSet(new long[]{0x0000000C7C000000L});
    public static final BitSet FOLLOW_gn_action_par_def_in_generate_network277 = new BitSet(new long[]{0x0000000000000000L,0x00000000000C0000L});
    public static final BitSet FOLLOW_RBRACKET_in_generate_network292 = new BitSet(new long[]{0x0000000000000000L,0x0000000000400000L});
    public static final BitSet FOLLOW_RPAREN_in_generate_network296 = new BitSet(new long[]{0x0000000000000000L,0x0000000000002000L});
    public static final BitSet FOLLOW_SEMI_in_generate_network298 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_MAX_AGG_in_gn_action_par_def346 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_ASSIGNS_in_gn_action_par_def348 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000400L});
    public static final BitSet FOLLOW_INT_in_gn_action_par_def352 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_MAX_ITER_in_gn_action_par_def368 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_ASSIGNS_in_gn_action_par_def370 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000400L});
    public static final BitSet FOLLOW_INT_in_gn_action_par_def374 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_MAX_STOICH_in_gn_action_par_def390 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_ASSIGNS_in_gn_action_par_def392 = new BitSet(new long[]{0x0000000000000000L,0x0000000000001000L});
    public static final BitSet FOLLOW_hash_value_in_gn_action_par_def394 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_OVERWRITE_in_gn_action_par_def408 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_ASSIGNS_in_gn_action_par_def410 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000400L});
    public static final BitSet FOLLOW_INT_in_gn_action_par_def414 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_PRINT_ITER_in_gn_action_par_def430 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_ASSIGNS_in_gn_action_par_def432 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000400L});
    ...
    public static final BitSet FOLLOW_SIMULATE_ODE_in_simulate_ode559 = new BitSet(new long[]{0x0000000000000000L,0x0000000000200000L});
    public static final BitSet FOLLOW_LPAREN_in_simulate_ode561 = new BitSet(new long[]{0x0000000000000000L,0x0000000000020000L});
    public static final BitSet FOLLOW_LBRACKET_in_simulate_ode563 = new BitSet(new long[]{0x01FE000C7C000000L,0x0000000000040000L});
    public static final BitSet FOLLOW_ps_par_def_in_simulate_ode576 = new BitSet(new long[]{0x0000000000000000L,0x00000000000C0000L});
    public static final BitSet FOLLOW_simulate_par_def_in_simulate_ode579 = new BitSet(new long[]{0x0000000000000000L,0x00000000000C0000L});
    public static final BitSet FOLLOW_simulate_ode_par_def_in_simulate_ode582 = new BitSet(new long[]{0x0000000000000000L,0x00000000000C0000L});
    public static final BitSet FOLLOW_COMMA_in_simulate_ode597 = new BitSet(new long[]{0x01FE000C7C000000L});
    public static final BitSet FOLLOW_ps_par_def_in_simulate_ode600 = new BitSet(new long[]{0x0000000000000000L,0x00000000000C0000L});
    public static final BitSet FOLLOW_simulate_par_def_in_simulate_ode603 = new BitSet(new long[]{0x0000000000000000L,0x00000000000C0000L});
    public static final BitSet FOLLOW_simulate_ode_par_def_in_simulate_ode606 = new BitSet(new long[]{0x0000000000000000L,0x00000000000C0000L});
    public static final BitSet FOLLOW_RBRACKET_in_simulate_ode625 = new BitSet(new long[]{0x0000000000000000L,0x0000000000400000L});
    public static final BitSet FOLLOW_RPAREN_in_simulate_ode627 = new BitSet(new long[]{0x0000000000000000L,0x0000000000002000L});
    public static final BitSet FOLLOW_SEMI_in_simulate_ode629 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_SIMULATE_SSA_in_simulate_ssa655 = new BitSet(new long[]{0x0000000000000000L,0x0000000000200000L});
    public static final BitSet FOLLOW_LPAREN_in_simulate_ssa657 = new BitSet(new long[]{0x0000000000000000L,0x0000000000020000L});
    public static final BitSet FOLLOW_LBRACKET_in_simulate_ssa659 = new BitSet(new long[]{0x01E0000C7C000000L,0x0000000000040000L});
    public static final BitSet FOLLOW_ps_par_def_in_simulate_ssa673 = new BitSet(new long[]{0x0000000000000000L,0x00000000000C0000L});
    public static final BitSet FOLLOW_simulate_par_def_in_simulate_ssa676 = new BitSet(new long[]{0x0000000000000000L,0x00000000000C0000L});
    public static final BitSet FOLLOW_COMMA_in_simulate_ssa681 = new BitSet(new long[]{0x01E0000C7C000000L});
    public static final BitSet FOLLOW_ps_par_def_in_simulate_ssa684 = new BitSet(new long[]{0x0000000000000000L,0x00000000000C0000L});
    public static final BitSet FOLLOW_simulate_par_def_in_simulate_ssa687 = new BitSet(new long[]{0x0000000000000000L,0x00000000000C0000L});
    public static final BitSet FOLLOW_RBRACKET_in_simulate_ssa705 = new BitSet(new long[]{0x0000000000000000L,0x0000000000400000L});
    public static final BitSet FOLLOW_RPAREN_in_simulate_ssa707 = new BitSet(new long[]{0x0000000000000000L,0x0000000000002000L});
    public static final BitSet FOLLOW_SEMI_in_simulate_ssa709 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_READFILE_in_read_file732 = new BitSet(new long[]{0x0000000000000000L,0x0000000000200000L});
    public static final BitSet FOLLOW_LPAREN_in_read_file734 = new BitSet(new long[]{0x0000000000000000L,0x0000000000420000L});
    public static final BitSet FOLLOW_LBRACKET_in_read_file746 = new BitSet(new long[]{0x1000000000000000L,0x0000000000040000L});
    public static final BitSet FOLLOW_FILE_in_read_file749 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_ASSIGNS_in_read_file751 = new BitSet(new long[]{0x0000000000000000L,0x0000000000001000L});
    public static final BitSet FOLLOW_STRING_in_read_file753 = new BitSet(new long[]{0x0000000000000000L,0x0000000000040000L});
    public static final BitSet FOLLOW_RBRACKET_in_read_file759 = new BitSet(new long[]{0x0000000000000000L,0x0000000000400000L});
    public static final BitSet FOLLOW_RPAREN_in_read_file772 = new BitSet(new long[]{0x0000000000000000L,0x0000000000002000L});
    public static final BitSet FOLLOW_SEMI_in_read_file774 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_write_type_in_write_file818 = new BitSet(new long[]{0x0000000000000000L,0x0000000000200000L});
    public static final BitSet FOLLOW_LPAREN_in_write_file830 = new BitSet(new long[]{0x0000000000000000L,0x0000000000420000L});
    public static final BitSet FOLLOW_LBRACKET_in_write_file833 = new BitSet(new long[]{0x0000000000000000L,0x0000000000040000L});
    public static final BitSet FOLLOW_RBRACKET_in_write_file835 = new BitSet(new long[]{0x0000000000000000L,0x0000000000400000L});
    public static final BitSet FOLLOW_RPAREN_in_write_file850 = new BitSet(new long[]{0x0000000000000000L,0x0000000000002000L});
    ...
    public static final BitSet FOLLOW_SETCONCENTRATION_in_set_concentration953 = new BitSet(new long[]{0x0000000000000000L,0x0000000000200000L});
    public static final BitSet FOLLOW_LPAREN_in_set_concentration955 = new BitSet(new long[]{0x0000000000000000L,0x0000040000000000L});
    public static final BitSet FOLLOW_variable_definition_in_set_concentration957 = new BitSet(new long[]{0x0000000000000000L,0x0000000000400000L});
    public static final BitSet FOLLOW_RPAREN_in_set_concentration978 = new BitSet(new long[]{0x0000000000000000L,0x0000000000002000L});
    public static final BitSet FOLLOW_SEMI_in_set_concentration980 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_SETPARAMETER_in_set_parameter1026 = new BitSet(new long[]{0x0000000000000000L,0x0000000000200000L});
    public static final BitSet FOLLOW_LPAREN_in_set_parameter1028 = new BitSet(new long[]{0x0000000000000000L,0x0000040000000000L});
    public static final BitSet FOLLOW_parameter_definition_in_set_parameter1030 = new BitSet(new long[]{0x0000000000000000L,0x0000000000400000L});
    public static final BitSet FOLLOW_RPAREN_in_set_parameter1053 = new BitSet(new long[]{0x0000000000000000L,0x0000000000002000L});
    public static final BitSet FOLLOW_SEMI_in_set_parameter1055 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_DBQUOTES_in_parameter_definition1089 = new BitSet(new long[]{0x0000000000000000L,0x0000000000001000L});
    public static final BitSet FOLLOW_STRING_in_parameter_definition1092 = new BitSet(new long[]{0x0000000000000000L,0x0000040000000000L});
    public static final BitSet FOLLOW_DBQUOTES_in_parameter_definition1097 = new BitSet(new long[]{0x0000000000000000L,0x0000000000080000L});
    public static final BitSet FOLLOW_COMMA_in_parameter_definition1099 = new BitSet(new long[]{0x0000100000000000L,0x0000042000201600L});
    public static final BitSet FOLLOW_expression_in_parameter_definition1105 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_DBQUOTES_in_parameter_definition1113 = new BitSet(new long[]{0x0000100000000000L,0x0000002000201600L});
    public static final BitSet FOLLOW_expression_in_parameter_definition1117 = new BitSet(new long[]{0x0000000000000000L,0x0000040000000000L});
    public static final BitSet FOLLOW_DBQUOTES_in_parameter_definition1120 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_DBQUOTES_in_variable_definition1152 = new BitSet(new long[]{0x0000000000000000L,0x000000000A001000L});
    public static final BitSet FOLLOW_species_def_in_variable_definition1155 = new BitSet(new long[]{0x0000000000000000L,0x0000040000000000L});
    public static final BitSet FOLLOW_DBQUOTES_in_variable_definition1161 = new BitSet(new long[]{0x0000000000000000L,0x0000000000080000L});
    public static final BitSet FOLLOW_COMMA_in_variable_definition1163 = new BitSet(new long[]{0x0000100000000000L,0x0000042000201600L});
    public static final BitSet FOLLOW_expression_in_variable_definition1169 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_DBQUOTES_in_variable_definition1177 = new BitSet(new long[]{0x0000100000000000L,0x0000002000201600L});
    public static final BitSet FOLLOW_expression_in_variable_definition1181 = new BitSet(new long[]{0x0000000000000000L,0x0000040000000000L});
    public static final BitSet FOLLOW_DBQUOTES_in_variable_definition1184 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_SAVECONCENTRATIONS_in_save_concentrations1241 = new BitSet(new long[]{0x0000000000000000L,0x0000000000200000L});
    public static final BitSet FOLLOW_LPAREN_in_save_concentrations1243 = new BitSet(new long[]{0x0000000000000000L,0x0000000000400000L});
    public static final BitSet FOLLOW_RPAREN_in_save_concentrations1245 = new BitSet(new long[]{0x0000000000000000L,0x0000000000002000L});
    public static final BitSet FOLLOW_SEMI_in_save_concentrations1247 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_RESETCONCENTRATIONS_in_reset_concentrations1280 = new BitSet(new long[]{0x0000000000000000L,0x0000000000200000L});
    public static final BitSet FOLLOW_LPAREN_in_reset_concentrations1282 = new BitSet(new long[]{0x0000000000000000L,0x0000000000400000L});
    public static final BitSet FOLLOW_RPAREN_in_reset_concentrations1284 = new BitSet(new long[]{0x0000000000000000L,0x0000000000002000L});
    public static final BitSet FOLLOW_SEMI_in_reset_concentrations1286 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_STRING_in_hash_value1319 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_ASSIGNS_in_hash_value1321 = new BitSet(new long[]{0x0000000000000000L,0x0000000000020000L});
    public static final BitSet FOLLOW_LBRACKET_in_hash_value1323 = new BitSet(new long[]{0x0000000000000000L,0x0000000000001000L});
    public static final BitSet FOLLOW_assignment_list_in_hash_value1325 = new BitSet(new long[]{0x0000000000000000L,0x0000000000040000L});
    public static final BitSet FOLLOW_RBRACKET_in_hash_value1327 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_STRING_in_assignment_list1351 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_ASSIGNS_in_assignment_list1353 = new BitSet(new long[]{0x0000000000000000L,0x0000000000001600L});
    public static final BitSet FOLLOW_value_in_assignment_list1355 = new BitSet(new long[]{0x0000000000000000L,0x0000000000080000L});
    public static final BitSet FOLLOW_COMMA_in_assignment_list1358 = new BitSet(new long[]{0x0000000000000000L,0x0000000000001000L});
    public static final BitSet FOLLOW_STRING_in_assignment_list1360 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_ASSIGNS_in_assignment_list1362 = new BitSet(new long[]{0x0000000000000000L,0x0000000000001600L});
    ...
    public static final BitSet FOLLOW_PREFFIX_in_ps_par_def1416 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_ASSIGNS_in_ps_par_def1418 = new BitSet(new long[]{0x0000000000000000L,0x0000040000001000L});
    public static final BitSet FOLLOW_DBQUOTES_in_ps_par_def1422 = new BitSet(new long[]{0x0000000000000000L,0x0000000000001000L});
    public static final BitSet FOLLOW_STRING_in_ps_par_def1425 = new BitSet(new long[]{0x0000000000000000L,0x0000040000000000L});
    ...
    public static final BitSet FOLLOW_SUFFIX_in_ps_par_def1445 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_ASSIGNS_in_ps_par_def1447 = new BitSet(new long[]{0x0000000000000000L,0x0000040000001000L});
    public static final BitSet FOLLOW_DBQUOTES_in_ps_par_def1451 = new BitSet(new long[]{0x0000000000000000L,0x0000000000001000L});
    public static final BitSet FOLLOW_STRING_in_ps_par_def1454 = new BitSet(new long[]{0x0000000000000000L,0x0000040000000000L});
    ...
    public static final BitSet FOLLOW_ATOL_in_simulate_ode_par_def1487 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_ASSIGNS_in_simulate_ode_par_def1489 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000200L});
    public static final BitSet FOLLOW_FLOAT_in_simulate_ode_par_def1493 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_RTOL_in_simulate_ode_par_def1507 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_ASSIGNS_in_simulate_ode_par_def1509 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000200L});
    public static final BitSet FOLLOW_FLOAT_in_simulate_ode_par_def1513 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_STEADY_STATE_in_simulate_ode_par_def1527 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_ASSIGNS_in_simulate_ode_par_def1529 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000400L});
    public static final BitSet FOLLOW_INT_in_simulate_ode_par_def1533 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_SPARSE_in_simulate_ode_par_def1547 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_ASSIGNS_in_simulate_ode_par_def1549 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000400L});
    public static final BitSet FOLLOW_INT_in_simulate_ode_par_def1553 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_T_END_in_simulate_par_def1580 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_ASSIGNS_in_simulate_par_def1582 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000600L});
    ...
    public static final BitSet FOLLOW_T_START_in_simulate_par_def1609 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_ASSIGNS_in_simulate_par_def1611 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000600L});
    ...
    public static final BitSet FOLLOW_N_STEPS_in_simulate_par_def1637 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_ASSIGNS_in_simulate_par_def1639 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000400L});
    public static final BitSet FOLLOW_INT_in_simulate_par_def1643 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_SAMPLE_TIMES_in_simulate_par_def1657 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
    public static final BitSet FOLLOW_ASSIGNS_in_simulate_par_def1659 = new BitSet(new long[]{0x0000000000000000L,0x0000000000008000L});
    public static final BitSet FOLLOW_array_value_in_simulate_par_def1663 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LSBRACKET_in_array_value1696 = new BitSet(new long[]{0x0000000000000000L,0x0000000000001000L});
    public static final BitSet FOLLOW_STRING_in_array_value1698 = new BitSet(new long[]{0x0000000000000000L,0x0000000000090000L});
    public static final BitSet FOLLOW_COMMA_in_array_value1701 = new BitSet(new long[]{0x0000000000000000L,0x0000000000001000L});
    public static final BitSet FOLLOW_STRING_in_array_value1703 = new BitSet(new long[]{0x0000000000000000L,0x0000000000090000L});
    public static final BitSet FOLLOW_RSBRACKET_in_array_value1707 = new BitSet(new long[]{0x0000000000000002L});
