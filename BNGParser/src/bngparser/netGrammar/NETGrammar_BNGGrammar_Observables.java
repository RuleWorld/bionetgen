// $ANTLR 3.3 Nov 30, 2010 12:50:56 BNGGrammar_Observables.g 2012-02-06 17:01:17
...
public class NETGrammar_BNGGrammar_Observables extends Parser {
    ...
    public NETGrammar gParent;
        ...
        public NETGrammar_BNGGrammar_Observables(TokenStream input, NETGrammar gNETGrammar) {
            this(input, new RecognizerSharedState(), gNETGrammar);
        }
        public NETGrammar_BNGGrammar_Observables(TokenStream input, RecognizerSharedState state, NETGrammar gNETGrammar) {
            super(input, state);
    ...
    protected StringTemplateGroup templateLib =
      new StringTemplateGroup("NETGrammar_BNGGrammar_ObservablesTemplates", AngleBracketTemplateLexer.class);
    ...
    public final NETGrammar_BNGGrammar_Observables.observables_block_return observables_block(List observables) throws RecognitionException {
        observables_block_stack.push(new observables_block_scope());
        NETGrammar_BNGGrammar_Observables.observables_block_return retval = new NETGrammar_BNGGrammar_Observables.observables_block_return();
        retval.start = input.LT(1);

        NETGrammar_BNGGrammar_Observables.observable_def_line_return s1 = null;
    ...
    public final NETGrammar_BNGGrammar_Observables.observable_def_line_return observable_def_line(String upperID) throws RecognitionException {
        observable_def_line_stack.push(new observable_def_line_scope());
        NETGrammar_BNGGrammar_Observables.observable_def_line_return retval = new NETGrammar_BNGGrammar_Observables.observable_def_line_return();
        retval.start = input.LT(1);

        Token STRING1=null;
        NETGrammar_BNGGrammar_Observables.observable_type_return s1 = null;

        NETGrammar_BNGGrammar_Observables.pattern_list_return pattern_list2 = null;
    ...
    public final NETGrammar_BNGGrammar_Observables.observable_type_return observable_type() throws RecognitionException {
        NETGrammar_BNGGrammar_Observables.observable_type_return retval = new NETGrammar_BNGGrammar_Observables.observable_type_return();
        retval.start = input.LT(1);
    ...
    // BNGGrammar_Observables.g:48:1: pattern_list[String upperID] : (s1= obs_species_def[upperID + \"_P\" + $pattern_list::patternCounter, $observables_block::reactionAction] ( ( COMMA | WS ) s2= obs_species_def[upperID + \"_P\" + $pattern_list::patternCounter, $observables_block::reactionAction] )* ) -> patterns_block(id=upperID + \"_P\" + $pattern_list::patternCountermolecules=$pattern_list::patterns);
    public final NETGrammar_BNGGrammar_Observables.pattern_list_return pattern_list(String upperID) throws RecognitionException {
        pattern_list_stack.push(new pattern_list_scope());
        NETGrammar_BNGGrammar_Observables.pattern_list_return retval = new NETGrammar_BNGGrammar_Observables.pattern_list_return();
        retval.start = input.LT(1);

        NETGrammar_BNGGrammar_Observables.obs_species_def_return s1 = null;

        NETGrammar_BNGGrammar_Observables.obs_species_def_return s2 = null;
        ...
        try {
            // BNGGrammar_Observables.g:62:9: ( (s1= obs_species_def[upperID + \"_P\" + $pattern_list::patternCounter, $observables_block::reactionAction] ( ( COMMA | WS ) s2= obs_species_def[upperID + \"_P\" + $pattern_list::patternCounter, $observables_block::reactionAction] )* ) -> patterns_block(id=upperID + \"_P\" + $pattern_list::patternCountermolecules=$pattern_list::patterns))
            // BNGGrammar_Observables.g:62:11: (s1= obs_species_def[upperID + \"_P\" + $pattern_list::patternCounter, $observables_block::reactionAction] ( ( COMMA | WS ) s2= obs_species_def[upperID + \"_P\" + $pattern_list::patternCounter, $observables_block::reactionAction] )* )
            {
            // BNGGrammar_Observables.g:62:11: (s1= obs_species_def[upperID + \"_P\" + $pattern_list::patternCounter, $observables_block::reactionAction] ( ( COMMA | WS ) s2= obs_species_def[upperID + \"_P\" + $pattern_list::patternCounter, $observables_block::reactionAction] )* )
            // BNGGrammar_Observables.g:62:12: s1= obs_species_def[upperID + \"_P\" + $pattern_list::patternCounter, $observables_block::reactionAction] ( ( COMMA | WS ) s2= obs_species_def[upperID + \"_P\" + $pattern_list::patternCounter, $observables_block::reactionAction] )*
            {
            ...
            // BNGGrammar_Observables.g:79:9: ( ( COMMA | WS ) s2= obs_species_def[upperID + \"_P\" + $pattern_list::patternCounter, $observables_block::reactionAction] )*
            loop6:
            do {
                int alt6=2;
                int LA6_0 = input.LA(1);

                if ( (LA6_0==WS||LA6_0==COMMA) ) {
                    alt6=1;
                }
                ...
                switch (alt6) {
            	case 1 :
            	    // BNGGrammar_Observables.g:81:9: ( COMMA | WS ) s2= obs_species_def[upperID + \"_P\" + $pattern_list::patternCounter, $observables_block::reactionAction]
            	    {
            	    // BNGGrammar_Observables.g:81:9: ( COMMA | WS )
            	    int alt5=2;
            	    ...
            	    switch (alt5) {
            	        case 1 :
            	            // BNGGrammar_Observables.g:81:10: COMMA
            	            {
            	            match(input,COMMA,FOLLOW_COMMA_in_pattern_list348); 

            	            }
            	            break;
            	        case 2 :
            	            // BNGGrammar_Observables.g:81:16: WS
            	            {
            	            match(input,WS,FOLLOW_WS_in_pattern_list350); 
            	    ...
            	    pushFollow(FOLLOW_obs_species_def_in_pattern_list381);
            ...
            // TEMPLATE REWRITE
            // 88:8: -> patterns_block(id=upperID + \"_P\" + $pattern_list::patternCountermolecules=$pattern_list::patterns)
            {
    ...
    // BNGGrammar_Observables.g:92:2: obs_species_def[String upperID,ReactionAction reactionAction] returns [int stoichiometry,Map <String,List<ReactionRegister>> map] : s1= ( species_def[$obs_species_def::reactants,$obs_species_def::bonds,upperID] ) -> rule_seed_species_block(id=upperIDmolecules=$obs_species_def::reactantsfirstBonds=$obs_species_def::bonds.getLeft()secondBonds=$obs_species_def::bonds.getRight());
    public final NETGrammar_BNGGrammar_Observables.obs_species_def_return obs_species_def(String upperID, ReactionAction reactionAction) throws RecognitionException {
        obs_species_def_stack.push(new obs_species_def_scope());
        NETGrammar_BNGGrammar_Observables.obs_species_def_return retval = new NETGrammar_BNGGrammar_Observables.obs_species_def_return();
        retval.start = input.LT(1);
        ...
        try {
            // BNGGrammar_Observables.g:102:1: (s1= ( species_def[$obs_species_def::reactants,$obs_species_def::bonds,upperID] ) -> rule_seed_species_block(id=upperIDmolecules=$obs_species_def::reactantsfirstBonds=$obs_species_def::bonds.getLeft()secondBonds=$obs_species_def::bonds.getRight()))
            // BNGGrammar_Observables.g:104:2: s1= ( species_def[$obs_species_def::reactants,$obs_species_def::bonds,upperID] )
            {
            // BNGGrammar_Observables.g:104:5: ( species_def[$obs_species_def::reactants,$obs_species_def::bonds,upperID] )
            // BNGGrammar_Observables.g:104:6: species_def[$obs_species_def::reactants,$obs_species_def::bonds,upperID]
            {
            pushFollow(FOLLOW_species_def_in_obs_species_def453);
            species_def3=gNETGrammar.species_def(((obs_species_def_scope)obs_species_def_stack.peek()).reactants, ((obs_species_def_scope)obs_species_def_stack.peek()).bonds, upperID);
            ...
            // TEMPLATE REWRITE
            // 110:5: -> rule_seed_species_block(id=upperIDmolecules=$obs_species_def::reactantsfirstBonds=$obs_species_def::bonds.getLeft()secondBonds=$obs_species_def::bonds.getRight())
            {
    ...
    public static final BitSet FOLLOW_OBSERVABLES_in_observables_block60 = new BitSet(new long[]{0x0000000000002480L,0x0000000000001400L});
    public static final BitSet FOLLOW_observable_def_line_in_observables_block65 = new BitSet(new long[]{0x0000000000002480L,0x0000000000001400L});
    ...
    public static final BitSet FOLLOW_INT_in_observable_def_line133 = new BitSet(new long[]{0x0000000000002400L,0x0000000000001000L});
    public static final BitSet FOLLOW_observable_type_in_observable_def_line150 = new BitSet(new long[]{0x0000000000000000L,0x0000000000001000L});
    public static final BitSet FOLLOW_STRING_in_observable_def_line154 = new BitSet(new long[]{0x0000000000000000L,0x000000000A001000L});
    ...
    public static final BitSet FOLLOW_obs_species_def_in_pattern_list279 = new BitSet(new long[]{0x0000000000000022L,0x0000000000080000L});
    public static final BitSet FOLLOW_COMMA_in_pattern_list348 = new BitSet(new long[]{0x0000000000000000L,0x000000000A001000L});
    public static final BitSet FOLLOW_WS_in_pattern_list350 = new BitSet(new long[]{0x0000000000000000L,0x000000000A001000L});
    public static final BitSet FOLLOW_obs_species_def_in_pattern_list381 = new BitSet(new long[]{0x0000000000000022L,0x0000000000080000L});
    public static final BitSet FOLLOW_species_def_in_obs_species_def453 = new BitSet(new long[]{0x0000000000000002L});
