// $ANTLR 3.3 Nov 30, 2010 12:50:56 BNGGrammar_Parameters.g 2012-02-06 17:01:16
...
public class NETGrammar_BNGGrammar_Parameters extends Parser {
    ...
    public NETGrammar gParent;
        ...
        public NETGrammar_BNGGrammar_Parameters(TokenStream input, NETGrammar gNETGrammar) {
            this(input, new RecognizerSharedState(), gNETGrammar);
        }
        public NETGrammar_BNGGrammar_Parameters(TokenStream input, RecognizerSharedState state, NETGrammar gNETGrammar) {
            super(input, state);
    ...
    protected StringTemplateGroup templateLib =
      new StringTemplateGroup("NETGrammar_BNGGrammar_ParametersTemplates", AngleBracketTemplateLexer.class);
    ...
    public final NETGrammar_BNGGrammar_Parameters.parameters_block_return parameters_block(Map<String,Register> memory, List parameters) throws RecognitionException {
        parameters_block_stack.push(new parameters_block_scope());
        NETGrammar_BNGGrammar_Parameters.parameters_block_return retval = new NETGrammar_BNGGrammar_Parameters.parameters_block_return();
        retval.start = input.LT(1);

        NETGrammar_BNGGrammar_Parameters.parameter_def_return parameter_def1 = null;
    ...
    public final NETGrammar_BNGGrammar_Parameters.parameter_def_return parameter_def(Map<String,Register> lmemory) throws RecognitionException {
        NETGrammar_BNGGrammar_Parameters.parameter_def_return retval = new NETGrammar_BNGGrammar_Parameters.parameter_def_return();
        retval.start = input.LT(1);

        Token STRING2=null;
        NETGrammar_BNGGrammar_Expression.expression_return expression3 = null;
        ...
        try {
            ...
            expression3=gNETGrammar.expression(lmemory);
