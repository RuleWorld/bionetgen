...
class Reaction
{
    public:
        ...
        const std::vector<std::string>& get_reactants() const { return reactants; };
        const std::vector<std::string>& get_products() const { return products; };
        const std::set<std::string>& get_mechanisms() const { return mechanisms; };
